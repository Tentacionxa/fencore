...
maintainModeMessage = "We shut the server for maintenance. We will be back in 30 minutes!"
...
weekKillsToRedSkull = 56
monthKillsToRedSkull = 224
redSkullDuration = 3
...
forgeMaxItemTier = 10
forgeCostOneSliver = 5
forgeSliverAmount = 3
forgeCoreCost = 20
forgeMaxDust = 225
forgeFusionDustCost = 100
forgeConvergenceFusionDustCost = 100
forgeTransferDustCost = 100
forgeConvergenceTransferCost = 100
...
mysqlHost = "127.0.0.1"
mysqlUser = "xtenx"
mysqlPass = "ABAQCi2wrxqD+raQc21e"
...
rateHealthRegen = 3.0
rateHealthRegenSpeed = 3.0
rateManaRegen = 3.0
rateManaRegenSpeed = 3.0
rateSoulRegen = 2.0
