...
forgeBonusSuccessRate = 50
forgeTierLossReduction = 50
forgeAmountMultiplier = 20
forgeMinSlivers = 3
forgeMaxSlivers = 7
...
lootPouchMaxLimit = 50000
storeInboxMaxLimit = 50000
...
coinPacketSize = 25
coinImagesURL = "http://fencore.net/store/"
