local mType = Game.createMonsterType("Angry Rustabal")
local monster = {}

monster.description = "an angry rustabal"
...
monster.summon = {
	maxSummons = 1,
	summons = {
		{ name = "demon", chance = 25, interval = 2000, count = 2 },
	},
}
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "You wont get the soul treasure!", yell = false },
	{ text = "I SHALL KILL YOU!", yell = true },
...
monster.attacks = {
	...
	{ name = "melee", interval = 2000, chance = 500, minDamage = 0, maxDamage = -3940 },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = 0, maxDamage = -650, range = 7, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -650, maxDamage = -1300, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
	{ name = "firefield", interval = 2000, chance = 10, range = 7, radius = 1, shootEffect = CONST_ANI_FIRE, target = true },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -300, maxDamage = -900, length = 8, spread = 0, effect = CONST_ME_PURPLEENERGY, target = false },
