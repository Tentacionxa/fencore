local mType = Game.createMonsterType("Ballon King")
local monster = {}
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 13, type = COMBAT_PHYSICALDAMAGE, minDamage = -550, maxDamage = -2400, radius = 3, effect = CONST_ME_GROUNDSHAKER, target = false},
