local mType = Game.createMonsterType("Ballon Cowboy")
local monster = {}

monster.description = "a Ballon Cowboy"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 17, type = COMBAT_HOLYDAMAGE, minDamage = -550, maxDamage = -1100, radius = 4, effect = CONST_ME_HOLYAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 13, type = COMBAT_PHYSICALDAMAGE, minDamage = -550, maxDamage = -1000, radius = 3, effect = CONST_ME_GROUNDSHAKER, target = false},
