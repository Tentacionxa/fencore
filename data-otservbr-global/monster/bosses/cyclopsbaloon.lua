local mType = Game.createMonsterType("Ballon Cyclops")
local monster = {}

monster.description = "a Ballon Cyclops"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 13, type = COMBAT_PHYSICALDAMAGE, minDamage = -550, maxDamage = -1500, radius = 3, effect = CONST_ME_GROUNDSHAKER, target = false},
