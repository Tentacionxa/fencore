...
monster.loot = {
	...
	{ name = "bulltaur horn", chance = 15000, maxCount = 1 },
	{ name = "gold ingot", chance = 15000, maxCount = 2 },
	{ name = "spellweaver's robe", chance = 5000, maxCount = 1 },
	{ name = "gold ring", chance = 15000, maxCount = 1 },
	{ name = "alloy legs", chance = 15000, maxCount = 1 },
