...
monster.loot = {
	...
	{ name = "bulltaur hoof", chance = 15000, maxCount = 1 },
	{ name = "might ring", chance = 15000, maxCount = 2 },
	{ name = "gold nugget", chance = 15000, maxCount = 1 },
	{ name = "white gem", chance = 15000, maxCount = 2 },
	{ name = "small topaz", chance = 5000, maxCount = 3 },
	{ name = "bulltaur armor scrap", chance = 15000, maxCount = 1 },
	{ name = "dwarven ring", chance = 15000, maxCount = 2 },
	{ name = "blue gem", chance = 15000, maxCount = 2 },
	{ name = "bulltaur horn", chance = 5000, maxCount = 2 },
