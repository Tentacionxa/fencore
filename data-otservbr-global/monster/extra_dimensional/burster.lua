...
monster.loot = {
    ...
    { name = "energy drink", chance = 5070 },
    { name = "cyan crystal fragment", chance = 5070 },
    { name = "curious matter", chance = 5070 },
    { name = "spark sphere", chance = 5070 },
    { name = "volatile proto matter", chance = 5070 },
}
