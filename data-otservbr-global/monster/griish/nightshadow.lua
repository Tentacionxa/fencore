local mType = Game.createMonsterType("Night Shadow")
local monster = {}

monster.description = "Night Shadow"
...
monster.loot = {
	...
	{id = 46316, chance = 100000, maxCount = 10},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -10000, maxDamage = -13000},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -7000, maxDamage = -10000, radius = 7, effect = 215, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -8000, maxDamage = -12000, range = 4, radius = 7, effect = 48, target = true},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -9000, maxDamage = -15000, length = 10, spread = 3, effect = 184, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DROWNDAMAGE, minDamage = -9000, maxDamage = -19000, length = 10, spread = 3, effect = 195, target = false},
