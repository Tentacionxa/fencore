local mType = Game.createMonsterType("Sub Holy")
local monster = {}

monster.description = "Sub Holy"
...
monster.summon = {
    maxSummons = 4,
    summons = {
        { name = "Sub Physisan", chance = 100, interval = 1000, count = 4 },
    },
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -4000, maxDamage = -7000},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -4000, maxDamage = -7000, radius = 8, effect = CONST_ME_HOLYDAMAGE, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -4000, maxDamage = -7000, range = 4, radius = 4, effect = CONST_ME_YELLOWENERGY, target = true},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -4000, maxDamage = -7000, length = 10, spread = 3, effect = 50, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -4000, maxDamage = -7000, length = 10, spread = 3, effect = 181, target = false},
}
