...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 18, type = COMBAT_PHYSICALDAMAGE, minDamage = -2000, maxDamage = -3000, radius = 2, effect = CONST_ME_GROUNDSHAKER, target = false },
	{ name = "combat", interval = 2000, chance = 14, type = COMBAT_PHYSICALDAMAGE, minDamage = -2000, maxDamage = -3000, length = 5, spread = 0, effect = 10, target = false },
}
