local mType = Game.createMonsterType("Sub Physisan")
local monster = {}

monster.description = "a sub physisan"
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 80, type = COMBAT_HOLYDAMAGE, minDamage = -2000, maxDamage = -3000, radius = 2, effect = 4, target = false },
	{ name = "combat", interval = 2000, chance = 24, type = COMBAT_HOLYDAMAGE, minDamage = -2000, maxDamage = -3000, length = 5, spread = 3, effect = 29, target = false },
}
