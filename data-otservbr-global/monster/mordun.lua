local mType = Game.createMonsterType("Mordun")
local monster = {}

monster.description = "Mordun"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{ text = "YOU WONT GET MY TREASURE", yell = true },
	{ text = "I SHALL KILL YOU", yell = true },
	{ text = "I AM MORDUN OF THE TRIANGLE... AND I AM HERE TO CHALLENGE YOU ALL.", yell = true },
