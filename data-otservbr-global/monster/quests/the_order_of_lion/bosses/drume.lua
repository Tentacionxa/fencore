...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_HOLYDAMAGE, minDamage = -450, maxDamage = -650, length = 8, spread = 3, effect = CONST_ME_HOLYAREA, target = false },
	...
	{ name = "combat", interval = 2000, chance = 22, type = COMBAT_DEATHDAMAGE, minDamage = -400, maxDamage = -600, radius = 3, effect = CONST_ME_MORTAREA, target = false },
	{ name = "combat", interval = 2000, chance = 24, type = COMBAT_ICEDAMAGE, minDamage = -500, maxDamage = -900, length = 4, spread = 0, effect = CONST_ME_ICEATTACK, target = false },
	{ name = "singlecloudchain", interval = 2000, chance = 34, minDamage = -300, maxDamage = -600, range = 4, effect = CONST_ME_ENERGYHIT, target = true },
}
