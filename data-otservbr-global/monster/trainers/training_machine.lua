local mType = Game.createMonsterType("Training Tower")
local monster = {}

monster.description = "a training tower"
...
monster.defenses = {
	defense = 10,
	armor = 7,
	{ name = "combat", type = COMBAT_HEALING, chance = 100, interval = 1000, minDamage = 50000, maxDamage = 100000, effect = CONST_ME_MAGIC_BLUE },
}
