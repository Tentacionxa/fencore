...
monster.attacks = {
	...
	{ name = "combat", interval = 1700, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -150, maxDamage = -350, radius = 3, shootEffect = CONST_ANI_ENVENOMEDARROW, target = true },
	...
	{ name = "combat", interval = 1700, chance = 35, type = COMBAT_DEATHDAMAGE, minDamage = -150, maxDamage = -350, radius = 3, effect = CONST_ME_MORTAREA, target = false },
}
