...
keywordHandler:addKeyword({ "trip" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Ottawa}, {Hellish Basin}, {Fearsome Desert}, {Damona Reef}, {Kinfroain}, {Lionfield Fort}, {Lamawood Isles}, {Dunly Refuge}, {Yalahar} or {Edron?}" })
keywordHandler:addKeyword({ "passage" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Ottawa}, {Hellish Basin}, {Fearsome Desert}, {Damona Reef}, {Kinfroain}, {Lionfield Fort}, {Lamawood Isles}, {Dunly Refuge}, {Yalahar} or {Edron?}" })
keywordHandler:addKeyword({ "town" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Ottawa}, {Hellish Basin}, {Fearsome Desert}, {Damona Reef}, {Kinfroain}, {Lionfield Fort}, {Lamawood Isles}, {Dunly Refuge}, {Yalahar} or {Edron?}" })
keywordHandler:addKeyword({ "destination" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Ottawa}, {Hellish Basin}, {Fearsome Desert}, {Damona Reef}, {Kinfroain}, {Lionfield Fort}, {Lamawood Isles}, {Dunly Refuge}, {Yalahar} or {Edron?}" })
keywordHandler:addKeyword({ "sail" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Ottawa}, {Hellish Basin}, {Fearsome Desert}, {Damona Reef}, {Kinfroain}, {Lionfield Fort}, {Lamawood Isles}, {Dunly Refuge}, {Yalahar} or {Edron?}" })
keywordHandler:addKeyword({ "go" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Ab'Dendriel}, {Venore}, {Svargrond},{Ottawa}, {Hellish Basin}, {Fearsome Desert}, {Damona Reef}, {Kinfroain}, {Lionfield Fort}, {Lamawood Isles}, {Dunly Refuge}, {Yalahar} or {Edron?}" })
