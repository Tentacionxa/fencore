...
-- Basic
keywordHandler:addKeyword({ "sail" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Krailos}, {Thais}, {Carlin}, {Ab'Dendriel}, {Venore}, {Port Hope}, {Ankrahmun}, {Liberty Bay}, {Ottawa}, {Hellish Basin}, {Fearsome Desert}, {Damona Reef}, {Kinfroain}, {Lionfield Fort}, {Lamawood Isles}, {Dunly Refuge}, {Gray Island} or the isle {Cormaya}?" })
