...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Welcome to the Angelic post office!" },
	{ text = "If you need help with letters or parcels, just ask me. I can explain everything." },
	{ text = "Hey, send a letter to your Angelic friend now and then. Keep in touch, you know." },
}
...
npcHandler:setMessage(MESSAGE_GREET, "Heavenly Blessings... How may I help you |PLAYERNAME|? Ask me for a {trade} if you want to buy something. I can also explain the {mail} system.")
