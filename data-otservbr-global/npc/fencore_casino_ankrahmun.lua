local npcName = "Fencore Casino Ankrahmun"
...
local cassinoConfig = {
	...
	counterPosition = Position(33120, 32838, 7),
	discardOfferPosition = Position(33120, 32839, 7), --USED TO MOVE ITENS THAT ARE NOT IN THE CURRENCY LIST AWAY FROM THE COUNTER
	playerPosition = Position(33121, 32839, 7),
	coins = {
		goldCoin = {
			id = 3031,
			enabled = true
