local npcName = "Fencore Casino Carlin"
...
local cassinoConfig = {
	...
	counterPosition = Position(32337, 31777, 7),
	discardOfferPosition = Position(32338, 31777, 7), --USED TO MOVE ITENS THAT ARE NOT IN THE CURRENCY LIST AWAY FROM THE COUNTER
	playerPosition = Position(32338, 31778, 7),
	coins = {
		goldCoin = {
			id = 3031,
			enabled = true
