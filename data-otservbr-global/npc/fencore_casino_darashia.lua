local npcName = "Fencore Casino Darashia"
...
local cassinoConfig = {
	...
	counterPosition = Position(33210, 32455, 8),
	discardOfferPosition = Position(33211, 32455, 8), --USED TO MOVE ITENS THAT ARE NOT IN THE CURRENCY LIST AWAY FROM THE COUNTER
	playerPosition = Position(33211, 32456, 8),
	coins = {
		goldCoin = {
			id = 3031,
			enabled = true
