local npcName = "Fencore Casino Edron"
...
local cassinoConfig = {
	...
	counterPosition = Position(33170, 31795, 8),
	discardOfferPosition = Position(33171, 31795, 8), --USED TO MOVE ITENS THAT ARE NOT IN THE CURRENCY LIST AWAY FROM THE COUNTER
	playerPosition = Position(33171, 31796, 8),
	coins = {
		goldCoin = {
			id = 3031,
			enabled = true
