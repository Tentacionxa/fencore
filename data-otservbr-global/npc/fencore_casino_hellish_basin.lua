local npcName = "Fencore Casino Hellish Basin"
...
local cassinoConfig = {
	availableGames = {
		...
		["HIT_THE_NUMBER"] = { enabled = true, odds = 5, howToPlay = "Just say a number between 1 to 6 with the offer in the counter. The Maximum You can play is 100 cc.", name = "Hit the number", description = "You have to guess the exact number within 1 to 6. The reward for this choice is: {odds}x"},
	},
	counterPosition = Position(31467, 31761, 8),
	discardOfferPosition = Position(31468, 31761, 8), --USED TO MOVE ITENS THAT ARE NOT IN THE CURRENCY LIST AWAY FROM THE COUNTER
	playerPosition = Position(31468, 31762, 8),
	coins = {
		goldCoin = {
			id = 3031,
			enabled = true
