local npcName = "Fencore Casino Kazordoon"
...
local cassinoConfig = {
	...
	counterPosition = Position(32656, 31910, 8),
	discardOfferPosition = Position(32657, 31910, 8), --USED TO MOVE ITENS THAT ARE NOT IN THE CURRENCY LIST AWAY FROM THE COUNTER
	playerPosition = Position(32657, 31911, 8),
	coins = {
		goldCoin = {
			id = 3031,
			enabled = true
