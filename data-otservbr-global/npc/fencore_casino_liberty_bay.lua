local npcName = "Fencore Casino Liberty Bay"
...
local cassinoConfig = {
	...
	counterPosition = Position(32332, 32831, 7),
	discardOfferPosition = Position(32333, 32831, 7), --USED TO MOVE ITENS THAT ARE NOT IN THE CURRENCY LIST AWAY FROM THE COUNTER
	playerPosition = Position(32333, 32832, 7),
	coins = {
		goldCoin = {
			id = 3031,
			enabled = true
