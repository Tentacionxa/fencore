local npcName = "Fencore Casino Svargrond"
...
local cassinoConfig = {
	...
	counterPosition = Position(32274, 31137, 7),
	discardOfferPosition = Position(32275, 31137, 7), --USED TO MOVE ITENS THAT ARE NOT IN THE CURRENCY LIST AWAY FROM THE COUNTER
	playerPosition = Position(32275, 31138, 7),
	coins = {
		goldCoin = {
			id = 3031,
			enabled = true
