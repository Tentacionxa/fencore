local npcName = "Fencore Casino Venore"
...
local cassinoConfig = {
	availableGames = {
		...
		["HIGH_LOW"] = { enabled = true, odds = 1, howToPlay = "Just say the word high or low with the offer in the counter.", name = "High / Low", description = "You have to guess if the rolled number will be 1/2/3 (low) or 4/5/6 (high). The reward for this choice is: {odds}x The Maximum You can play is 100 cc."},
	...
	counterPosition = Position(32916, 32068, 7),
	discardOfferPosition = Position(32917, 32068, 7), --USED TO MOVE ITENS THAT ARE NOT IN THE CURRENCY LIST AWAY FROM THE COUNTER
	playerPosition = Position(32917, 32069, 7),
	coins = {
		goldCoin = {
			id = 3031,
			enabled = true
