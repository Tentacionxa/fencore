local npcName = "Fencore Casino Yalahar"
...
local cassinoConfig = {
	...
	counterPosition = Position(32794, 31243, 7),
	discardOfferPosition = Position(32795, 31243, 7), --USED TO MOVE ITENS THAT ARE NOT IN THE CURRENCY LIST AWAY FROM THE COUNTER
	playerPosition = Position(32795, 31244, 7),
	coins = {
		goldCoin = {
			id = 3031,
			enabled = true
