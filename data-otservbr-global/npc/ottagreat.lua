local internalNpcName = "Otta Great"
...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Welcome to the Griish post office!" },
	{ text = "Poor soul... If you need help with letters or parcels, just ask me. I can explain everything." },
	{ text = "Souly Blessing! Send a letter to your friend now and then. Keep in touch, you know." },
}
...
npcHandler:setMessage(MESSAGE_GREET, "Griish Blessing |PLAYERNAME|. Ask me for a {trade} if you want to buy something. I can also explain the {mail} system.")
npcHandler:setMessage(MESSAGE_FAREWELL, "It was a pleasure to help you. Griish Blessing with You...")
