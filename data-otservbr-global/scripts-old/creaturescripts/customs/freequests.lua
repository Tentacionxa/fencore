...
local function playerFreeQuestStart(playerId, index)
	...
	for i = 1, 5 do
		...
		if not questTable[index] then
			player:sendTextMessage(MESSAGE_INFO_DESCR, "Acessos e outfits liberados.")
...
function freeQuests.onLogin(player)
	...
	player:sendTextMessage(MESSAGE_INFO_DESCR, "Aguarde, liberando acessos e outfits para seu personagem.")
