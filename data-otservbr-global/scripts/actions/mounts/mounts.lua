...
local config = {
	...
	[46310] = { NAME = "Death Strike", ID = 167, BREAK = true, TYPE = TYPE_MONSTER, CHANCE = 15, FAIL_MSG = { { 1, "Death Strike run to its world." }, { 2, "Death Strike stole the egg." } }, SUCCESS_MSG = "You have tamed death strike.", ACHIEV = "Well Roared, Lion!" },
	[46323] = { NAME = "Haze Strike", ID = 168, BREAK = true, TYPE = TYPE_MONSTER, CHANCE = 15, FAIL_MSG = { { 1, "Haze Strike run to its world." }, { 2, "Haze Strike stole the egg." } }, SUCCESS_MSG = "You have tamed hazed strike.", ACHIEV = "Well Roared, Lion!" },
	[46279] = { NAME = "Flame Rush", ID = 181, BREAK = true, TYPE = TYPE_MONSTER, CHANCE = 15, FAIL_MSG = { { 1, "Flame Rush run to its world." }, { 2, "Flame Rush stole the horseshoe." } }, SUCCESS_MSG = "You have tamed flame rush.", ACHIEV = "Well Roared, Lion!" },
	[46278] = { NAME = "Haze Rush", ID = 182, BREAK = true, TYPE = TYPE_MONSTER, CHANCE = 15, FAIL_MSG = { { 1, "Haze Rush run to its world." }, { 2, "Haze Rush stole the horseshoe." } }, SUCCESS_MSG = "You have tamed haze rush.", ACHIEV = "Well Roared, Lion!" },
	[46325] = { NAME = "Crest Nexus", ID = 707, BREAK = true, TYPE = TYPE_MONSTER, CHANCE = 15, FAIL_MSG = { { 1, "Crest Nexus run to its lair." }, { 2, "Crest Nexus stole the egg." } }, SUCCESS_MSG = "You have tamed the crest nexus.", ACHIEV = "Well Roared, Lion!" },
	[46322] = { NAME = "Haze Nexus", ID = 708, BREAK = true, TYPE = TYPE_MONSTER, CHANCE = 15, FAIL_MSG = { { 1, "Haze Nexus run to its lair." }, { 2, "Haze Nexus stole the egg." } }, SUCCESS_MSG = "You have tamed the haze nexus.", ACHIEV = "Well Roared, Lion!" },
	[46323] = { NAME = "Viol Nexus", ID = 709, BREAK = true, TYPE = TYPE_MONSTER, CHANCE = 15, FAIL_MSG = { { 1, "Viol Nexus run to its lair." }, { 2, "Viol Nexus stole the egg." } }, SUCCESS_MSG = "You have tamed the viol nexus.", ACHIEV = "Well Roared, Lion!" },
	[46324] = { NAME = "Golden Nexus", ID = 710, BREAK = true, TYPE = TYPE_MONSTER, CHANCE = 15, FAIL_MSG = { { 1, "Golden Nexus run to its lair." }, { 2, "Golden Nexus stole the egg." } }, SUCCESS_MSG = "You have tamed the golden nexus.", ACHIEV = "Well Roared, Lion!" },
	[46285] = { NAME = "Heavy Draptor", ID = 704, BREAK = true, TYPE = TYPE_MONSTER, CHANCE = 50, FAIL_MSG = { { 1, "Heavy Draptor run to its lair." }, { 2, "Heavy Draptor stole the egg." } }, SUCCESS_MSG = "You have tamed the heavy draptor.", ACHIEV = "Well Roared, Lion!" },
}
