local bosses = {'Faceless Bane', 'Tentugly\'s Head', 'The Duke Of The Depths', 'The Baron From Below', 'Urmahlullu The Weakened', 'Ravenous Hunger', 'Unaz The Mean', 'Vok The Freakish', 'Black Vixen', 'Sharpclaw', 'Darkfang', 'Bloodback', 'Irgix The Flimsy', 'The Fear Feaster', 'The Count Of The Core', 'Razzagorn', 'Mazoran', 'The Unwelcome', 'Drume', 'Magma Bubble', 'Goshnar\'s Cruelty', 'Timira The Many-Headed', 'Shulgrax', 'Scarlett Etzel', 'Grand Master Oberon', 'Ratmiral Blackwhiskers', 'Duke Krule', 'Alptramun', 'Maxxenius', 'Izcandar The Banished', 'Anomaly', 'World Devourer', 'Outburst', 'Eradicator', 'Rupture', 'King Zelos', 'Ferumbras Mortal Shell', 'Goshnar\'s Megalomania', 'Goshnar\'s Malice', 'Goshnar\'s Hatred', 'Lloyd', 'Lady Tenebris', 'The Enraged Thorn Knight', 'Dragonking Zyrtarch', 'Vemiath'}
