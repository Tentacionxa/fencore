...
local reward = {
	...
	vocationItems = {
		-- Sorcerer
		[14025] = {
			{ id = 3385, amount = 1 }, -- Mage hat
			{ id = 3567, amount = 1 }, -- Magician's robe
			{ id = 3557, amount = 1 }, -- Leather legs
			{ id = 3552, amount = 1 }, -- Leather boots
			{ id = 3074, amount = 1 }, -- Wand of vortex
			{ id = 3418, amount = 1 }, -- Spellbook
			{ id = 5710, amount = 1 }, -- Light Shovel
			{ id = 9596, amount = 1 }, -- Squeezing Gear of Girlpower
		},
		-- Druid
		[14026] = {
			{ id = 3385, amount = 1 }, -- Mage hat
		...
		-- Paladin
		[14027] = {
			{ id = 3385, amount = 1 }, -- Leader helmet
			{ id = 3567, amount = 1 }, -- Ranger's cloak
			{ id = 3557, amount = 1 }, -- Ranger legs
			{ id = 3552, amount = 1 }, -- Leather boots
			{ id = 3350, amount = 1 }, -- Bow
			{ id = 3277, amount = 1 }, -- Spear
			{ id = 3418, amount = 1 }, -- Quiver
		...
		-- Knight
		[14028] = {
			{ id = 3385, amount = 1 }, -- Soldier helmet
			{ id = 3567, amount = 1 }, -- Brass armor
			{ id = 3557, amount = 1 }, -- Brass legs
			{ id = 3552, amount = 1 }, -- Leather boots
			{ id = 7774, amount = 1 }, -- Jagged sword
			{ id = 17824, amount = 1 }, -- Swampling club
			{ id = 7773, amount = 1 }, -- steel axe
			{ id = 3418, amount = 1 }, -- Steel shield
			{ id = 5710, amount = 1 }, -- Light Shovel
			{ id = 9596, amount = 1 }, -- Squeezing Gear of Girlpower
		},
	},
