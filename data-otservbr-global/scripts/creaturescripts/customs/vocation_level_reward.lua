local table = {
   ...
   [{1, 5}] = {
     ...
     [80] = {items = {{itemid = 3043, count = 15}}, storage = 40103, msg = "You won 15 crystal coins for reaching level 80!"},
        ...
        [1100] = {items = {{itemid = 943, count = 20}}, storage = 40145, msg = "You won x20 Holy Soil for reaching level 1100!"},
        [1200] = {items = {{itemid = 22118, count = 150}}, storage = 40124, msg = "You won x150 Tibia Coins for reaching level 1200!"},
        [1300] = {items = {{itemid = 36725, count = 2}}, storage = 40150, msg = "You won x2 Stamina Extension for reaching level 1300!"},
        [1400] = {items = {{itemid = 14758, count = 2}}, storage = 40154, msg = "You won x2 Experience Scroll for reaching level 1400!"},
