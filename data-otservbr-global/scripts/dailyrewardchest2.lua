local config = {
    ...
    exhaustStorage = 30063, -- Storage of chest
...
local rewards = {
    { id = 3043, name = "Crystal Coins", count = 5, text = "a" },
    { id = 3043, name = "Crystal Coins", count = 7, text = "a" },
    { id = 3043, name = "Crystal Coins", count = 9, text = "a" },
    { id = 3043, name = "Crystal Coins", count = 10, text = "a" },
    { id = 3043, name = "Crystal Coins", count = 13, text = "a" },
    { id = 3043, name = "Crystal Coins", count = 15, text = "a" },
    { id = 3043, name = "Crystal Coins", count = 17, text = "a" }
