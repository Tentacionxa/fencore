local config = {
	...
	monsters = {
		{ name = "Archangel", pos = Position(32815, 33483, 4) },
		{ name = "Holy Guard", pos = Position(32818, 33478, 4) },
		{ name = "Holy Guard", pos = Position(32815, 33480, 4)},
		{ name = "Holy Guard", pos = Position(32817, 33478, 4) },
		{ name = "Holy Guard", pos = Position(32820, 33483, 4) },
		{ name = "Archangel", pos = Position(32821, 33477, 4) },
		{ name = "Holy Guard", pos = Position(32819, 33479, 4) },
		{ name = "Holy Guard", pos = Position(32821, 33476, 4) },
		{ name = "Archangel", pos = Position(32820, 33486, 4) },
	},
	specPos = {
