...
[11] = {
		teleportPosition = { x = 33398, y = 32200, z = 9 },
		bossName = "Sugar Daddy",
		timeToFightAgain = 2, -- In hour
		timeToDefeat = 20, -- In minutes
		destination = Position(33373, 32237, 9),
		bossPosition = Position(33373, 32225, 9),
		specPos = {
			from = Position(33361, 32214, 9),
			to = Position(33383, 32245, 9),
		},
		exitPosition = Position(33373, 32241, 9),
	},
}
