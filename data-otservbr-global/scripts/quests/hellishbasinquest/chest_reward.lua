...
function inServiceYalaharReward.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	elseif item.uid == 35036 then
        if player:getStorageValue(96550) <= 0 then
			player:setStorageValue(96550, 1)
			player:addItem(43875, 1)
			player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "You have found a grand sanguine battleaxe.")
		else
			player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "The chest is empty.")
		end
 elseif item.uid == 36026 then
        if player:getStorageValue(96550) <= 0 then
                        player:setStorageValue(96550, 1)
                        player:addItem(43871, 1)
                        player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "You have found a grand sanguine razor.")
                else
                        player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "The chest is empty.")
                end
...
inServiceYalaharReward:uid(35020, 35021, 35022, 35023, 35024, 35025, 35026, 35027, 35036, 36026)
