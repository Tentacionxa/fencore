local setting = {
	...
	centerDemonRoomPosition = {x = 32386, y = 32200, z = 7},
	demonsPositions = {
		{x = 32384, y = 32203, z = 7},
		{x = 32384, y = 32201, z = 7},
		{x = 32384, y = 32199, z = 7},
	...
	playersPositions = {
		{ fromPos = {x = 32393, y = 32207, z = 7}, toPos = {x = 32386, y = 32205, z = 7} },
		{ fromPos = {x = 32393, y = 32206, z = 7}, toPos = {x = 32386, y = 32204, z = 7} },
		{ fromPos = {x = 32393, y = 32205, z = 7}, toPos = {x = 32386, y = 32203, z = 7} },
		{ fromPos = {x = 32393, y = 32204, z = 7}, toPos = {x = 32386, y = 32202, z = 7} },
...
function lever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 2772 then
		...
		for i = 1, #setting.demonsPositions do
			Game.createMonster("Angry Bloodfam", setting.demonsPositions[i])
		end
