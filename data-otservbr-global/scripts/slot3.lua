local config = {
    ...
    prizePool = {
        {itemId = 44613, count = {1, 1}, chance = 4},
        {itemId = 44607, count = {1, 1}, chance = 4},
        {itemId = 44610, count = {1, 1}, chance = 3},
        {itemId = 44604, count = {1, 1}, chance = 5},
    },

    roulettePositions = {
        Position(33457, 32490, 14), -- 1
        Position(33457, 32491, 14), -- 2
        Position(33457, 32492, 14), -- 3
        Position(33458, 32490, 14), -- 4
        Position(33458, 32491, 14), -- 5
        Position(33458, 32492, 14), -- 6
        Position(33459, 32490, 14), -- 7
        Position(33459, 32491, 14), -- 8
        Position(33459, 32492, 14), -- 9
    },
