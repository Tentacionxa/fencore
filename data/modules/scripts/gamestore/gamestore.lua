...
HomeBanners = {
    images = { "home/season2.png", "home/season2.png" },
    delay = 10,
}
	...
	-- FENCORE SALE
{
		...
		name = "Fencore SALE",
		rookgaard = true,
		subclasses = { "Weapons", "Equipment", "Private Exp", "Extra", "Rune Skins", "Legendary Box", "Griish House", "Special Outfit", "Special Mount", "VIP" },
	},
		...
		offers = {
			{
				...
				itemtype = 47369,
				count = 1,
				description = "<i>You see a amber greataxe (Atk:8 physical + 50 earth, Def:34, axe fighting +4, critical hit chance 10%, critical extra damage +7%).It can only be wielded properly by knights of level 330 or higher.Augments: (Annihilation -> Powerful Impact).Imbuements: (Empty Slot, Empty Slot, Empty Slot).Classification: 4 Tier: 0 . It weighs 83.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "Amber_Wand.png" },
				name = "Amber Wand",
				price = 500,
				itemtype = 47372,
				count = 1,
				description = "<i>You see a amber wand (critical hit chance 10%, critical extra damage +3.5%, magic level +3, energy magic level +2, protection ice +6%).It can only be wielded properly by sorcerers of level 330 or higher.Augments: (Rage of The Skies -> Powerful Impact, Critical Extra Damage -> Powerful Impact).Imbuements: (Empty Slot, Empty Slot). Classification: 4 Tier: 0. It weighs 24.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "Amber_Crossbow.png" },
				name = "Amber Crossbow",
				price = 500,
				itemtype = 47377,
				count = 1,
				description = "<i>You see a amber crossbow (Range: 6, Atk +10, Hit% +7, distance fighting +3, critical hit chance 10%, critical extra damage +6%, protection energy +5%). It can only be wielded properly by paladins of level 330 or higher. Augments: (Divine Missile -> Powerful Impact). Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0. It weighs 47.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 47371,
				count = 1,
				description = "<i>You see a amber bow (Range: 6, Atk +9, Hit% +6, distance fighting +4, critical hit chance 10%, critical extra damage +6%, protection energy +5%). It can only be wielded properly by paladins of level 330 or higher. Augments: (Divine Grenade -> Powerful Impact). Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0. It weighs 47.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "Amber_Slayer.png" },
				name = "Amber Slayer",
				price = 500,
				itemtype = 47368,
				count = 1,
				description = "<i>You see a amber slayer (Atk:8 physical + 50 death, Def:34, sword fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> Powerful Impact). Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0. It weighs 60.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "Amber_Bludgeon.png" },
				name = "Amber Bludgeon",
				price = 500,
				itemtype = 47370,
				count = 1,
				description = "<i>You see a amber bludgeon (Atk:8 physical + 50 death, Def:34, club fighting +4, critical hit chance 10%, critical extra damage +7%). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> Powerful Impact). Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0. It weighs 91.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "Amber_Cudgel.png" },
				name = "Amber Cudgel",
				price = 500,
				itemtype = 47376,
				count = 1,
				description = "<i>You see a amber cudgel (Atk:8 physical + 46 fire, Def:32 +3, club fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> Powerful Impact). Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0. It weighs 68.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 47375,
				count = 1,
				description = "<i>You see a amber axe (Atk:8 physical + 46 ice, Def:32, axe fighting +4, critical hit chance 10%, critical extra damage +7%). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> Powerful Impact). Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0. It weighs 83.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},  
{
                                ...
                                itemtype = 47373,
                                count = 1,
                                description = "<i>You see a amber rod (critical hit chance 10%, critical extra damage +3.5%, magic level +3, ice magic level +2, protection fire +6%). It can only be wielded properly by druids of level 330 or higher. Augments: (Strong Ice Wave -> Powerful Impact, Critical Extra Damage -> Powerful Impact).Imbuements: (Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 24.00 oz.</i>",
                                type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
                                        state = GameStore.States.STATE_NEW,
                                        movable = true,
                        },
			...
			{
				icons = { "Amber_Sabre.png" },
				name = "Amber Sabre",
				price = 500,
				itemtype = 47374,
				count = 1,
				description = "<i>You see a amber sabre (Atk:8 physical + 46 energy, Def:32 +3, sword fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> Powerful Impact). Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 . It weighs 60.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
	...
	offers = {
			...
			},
			{
				...
				name = "Loot Rainbow Torch",
				price = 1000,
				itemtype = 39702,
				count = 1,
				description = "<i>This Magical Rainbow Torch will increase Your cap by 65%</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
	...
	offers = {
			{
				...
				itemtype = 49218,
				count = 100,
				description = "<i>Black Magic Wall rune</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
			},
			{
				icons = { "" },
				name = "Dark Purple Mwall",
				price = 100,
				itemtype = 49230,
				count = 100,
				description = "<i>Dark Purple Magic Wall rune</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
		{
			...
			itemtype = 49216,
			count = 100,
			description = "<i>Yellow Magic Wall rune</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			state = GameStore.States.STATE_NEW,
			movable = true,
		},
		{
			...
			itemtype = 49215,
			count = 100,
			description = "<i>Orange Magic Wall rune</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			state = GameStore.States.STATE_NEW,
			movable = true,
		},
		{
			icons = { "" },
			name = "Blue Green Mwall",
			price = 100,
			itemtype = 49226,
			count = 100,
			description = "<i>Blue Green Magic Wall rune</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			state = GameStore.States.STATE_NEW,
			movable = true,
		},
		{
			...
			itemtype = 49225,
			count = 100,
			description = "<i>Rainbow Magic Wall rune</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			state = GameStore.States.STATE_NEW,
			movable = true,
		},
		{
			...
			itemtype = 49192,
			count = 100,
			description = "<i>White Magic Wall rune</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			state = GameStore.States.STATE_NEW,
			movable = true,
		},
	...
	offers = {
...

		{
		...
		},
			{
				...
				itemtype = 46042,
				count = 1,
				description = "<i>This chest has 10 % chance of dropping an eternal night moon mantle or eternal night moon crown</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
			},
			{
				...
				itemtype = 46041,
				count = 1,
				description = "<i>This chest has 10 % chance of dropping an eternal night root mask or eternal night root robe</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
			},
			{
				...
				itemtype = 46039,
				count = 1,
				description = "<i>This chest has 10 % chance of dropping an eternal night demon helmet, eternal night demon plate</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
			},
			{
				...
				itemtype = 46040,
				count = 1,
				description = "<i>This chest has 10 % chance of dropping an eternal night shadow tabard, eternal night headguard</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
			},
	...
	offers = {
		...
		},
		{
			...
			offers = {
					{
						icons = { "" },
						name = "Chest of elder's",
						price = 300,
						itemtype = 46075,
						count = 1,
						description = "<i>A perfect Griish house inventory - Chest of elder's </i>",
						type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
						state = GameStore.States.STATE_NEW,
					},
					{
						icons = { "" },
						name = "Chest of elite's",
						price = 100,
						itemtype = 46077,
						count = 1,
						description = "<i>A perfect Griish house inventory - Chest of elite's </i>",
						type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
							state = GameStore.States.STATE_NEW,
					},
					{
						icons = { "" },
						name = "Chest of master's",
						price = 100,
						itemtype = 46079,
						count = 1,
						description = "<i>A perfect Griish house inventory - Chest of master's </i>",
						type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
							state = GameStore.States.STATE_NEW,
					},
				{
					icons = { "" },
					name = "Chest of royal's",
					price = 100,
					itemtype = 46081,
					count = 1,
					description = "<i>A perfect Griish house inventory - Chest of royal's </i>",
					type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
					state = GameStore.States.STATE_NEW,
					movable = true,
				},
				{
					icons = { "" },
					name = "Possessed chest",
					price = 100,
					itemtype = 46104,
					count = 1,
					description = "<i>Griish Soul Possessed Chest</i>",
					type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
					state = GameStore.States.STATE_NEW,
					movable = true,
				},
			...
			offers = {
					{
						...
						itemtype = 12812,
						count = 1,
						description = "<i>Let the powers of ancient gods recharge Your stamina. Will recharge Your full stamina.</i>",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
						state = GameStore.States.STATE_NEW,
					},
					{
					...
					},
				{
					...
					itemtype = 943,
					count = 100,
					description = "<i>Using this item on any equipment can increase its Tier up to Tier 10 for all type of item classification. Chance to upgrade is 40%. If you upgrade the tier will increase +1.  If You have Tier Any Tier  and fail to upgrade, Your money will be taken. (Item will stay with you) Cost of each Tier = 4kk</i>",
					type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
				},
					...
					offers = { 
					{
						...
						{
							icons = { "Outfit_Rootwalker_Male_Addon_3.png", "Outfit_Rootwalker_Female_Addon_3.png" },
							name = "Full Griish Scout Outfit",
							price = 1000,
							sexId = { female = 176, male = 171 },
							addon = 3,
							description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Let the power of nature take care of Your body.</i>",
							type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
						...
						{
							icons = { "Outfit_Rootwalker_Male_Addon_3.png", "Outfit_Rootwalker_Female_Addon_3.png" },
							name = "Full Griish Knight Outfit",
							price = 1000,
							sexId = { female = 178, male = 172 },
							addon = 3,
							description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Let the power of nature take care of Your body.</i>",
							type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
						...
						{
							icons = { "Outfit_Rootwalker_Male_Addon_3.png", "Outfit_Rootwalker_Female_Addon_3.png" },
							name = "Full Griish Mage Outfit",
							price = 1000,
							sexId = { female = 169, male = 170 },
							addon = 3,
							description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Let the power of nature take care of Your body.</i>",
							type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
						...
						{
							icons = { "Outfit_Rootwalker_Male_Addon_3.png", "Outfit_Rootwalker_Female_Addon_3.png" },
							name = "Full Griish Druid Outfit",
							price = 1000,
							sexId = { female = 162, male = 164 },
							addon = 3,
							description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Let the power of nature take care of Your body.</i>",
							type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
						...
						},
{
							...
							offers = {
...

								{
									...
									price = 1000,
									id = 232,
									description = "{character}\n{speedboost}\n\n<i>The one and only, undead skull, caught by the top most wanted Griish Mage Volta. </i>",
									type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
								},
								{
									icons = { "Haze Strike.png" },
									name = "Haze Strike",
									price = 1000,
									id = 233,
									description = "{character}\n{speedboost}\n\n<i>Haze Strike, known for its beauty and energy.</i>",
									type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
								},
								{
									icons = { "Flame Rush.png" },
									name = "Flame Rush",
									price = 1000,
									id = 234,
								...
								{
									icons = { "Heavy Draptor.png" },
									name = "Heavy Draptor",
									price = 1000,
									id = 240,
									description = "{character}\n{speedboost}\n\n<i>A gigantic rare case, of a heavy draptor, caught in Tiquanda.</i>",
									type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
								},
								{
									icons = { "White Ship.png" },
									name = "White Ship",
									price = 1000,
									id = 241,
								...
								},
								{
									...
									price = 1000,
									id = 247,
									description = "{character}\n{speedboost}\n\n<i>We will all remember, what almighty Seus, has sent to his citizens. One of a kind caught as a mount.</i>",
									type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
									home = true,
								},
							},
	...
	-- Cosmetics ~ Mounts
	{
		...
		offers = {
			...
			},
			{
				...
				price = 460,
				id = 222,
				description = "{character}\n{speedboost}\n\n<i>Legend has it that the wild within once reached the end of a rainbow of the tropical jungle and decided to stay there. Influenced by the mystical power of the rainbow, the mystic jaguar gave birth to an exceptional foal.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			...
			},
			{
				...
				price = 440,
				id = 227,
				description = "{character}\n{speedboost}\n\n<i>They say it came down from heaven. Others, that it followed the rainbow. We don't know where this mystical creature came from.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			...
			},
			{
				...
				price = 400,
				id = 228,
				description = "{character}\n{speedboost}\n\n<i>A lizard looking animal. As quick as a panther!</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			...
			},
			{
				...
				price = 400,
				id = 230,
				description = "{character}\n{speedboost}\n\n<i>Glacier Wyrms' brother. Legends say, it run away first, from its mother to protect the rest of the family.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			...
			},
			{
				...
				price = 400,
				id = 229,
				description = "{character}\n{speedboost}\n\n<i>The youngest of the lizards. Slim, small and quick.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			...
			},
			{
				...
				price = 400,
				id = 226,
				description = "{character}\n{speedboost}\n\n<i>Sun powered Pegasus. How much horse power can it have!?</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
  ...
  {
                                icons = { "Outfit_Celestial_Avenger.png", "Outfit_Celestial_Avenger.png" },
                                name = "Full Celestial Avenger",
                                price = 600,
			...
			{
				icons = { "Outfit_Draccoon_Herald_Male_Addon_3.png", "Outfit_Draccoon_Herald_Female_Addon_3.png" },
				name = "Full Draccoon Herald Outfit",
				price = 500,
				sexId = { female = 1723, male = 1722 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The draconian heart lays within the body of this suit. Let the magical creatures fly You away.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
		...
		offers = {
			{
				...
				name = "Dark Ferumbras Exercise Dummy",
				price = 2500,
				itemtype = 49310,
				count = 1,
			...
			{
				icons = { "Reward_Shrine.png" },
				name = "King Tibianus Exercise Dummy",
				price = 2500,
				itemtype = 49312,
				count = 1,
				description = "<i>Extra 40% Skill. Pick up your daily reward comfortably in your own four walls!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{useicon} use it to open the reward wall\n{backtoinbox}",
			...
			{
				icons = { "Reward_Shrine.png" },
				name = "Heavenly Angel Exercise Dummy",
				price = 2500,
				itemtype = 49316,
				count = 1,
				description = "<i>Extra 35% Skill. Pick up your daily reward comfortably in your own four walls!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{useicon} use it to open the reward wall\n{backtoinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
				home = true,
			},
			{
		...
		offers = {
			{
				...
				name = "Gold Experience Scroll",
				price = 1300,
				itemtype = 49266,
				count = 1,
				description = "<i>This experience scroll will provide you 12 hours extra 120 % experience on all monsters listed in Your server log. (Currently : Griish World monsters)",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				state = GameStore.States.STATE_NEW,
				movable = true,
			},
			...
			},
			{
				...
				itemtype = 49265,
				count = 1,
				description = "<i>This experience scroll will provide you 12 hours extra 80 % experience on all monster except those listed in Your server log. (Exception : Griish World monsters)",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				state = GameStore.States.STATE_NEW,
				movable = true,
			},
