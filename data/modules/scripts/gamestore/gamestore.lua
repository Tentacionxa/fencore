	...
	-- FENCORE SALE
{
		...
		offers = {
			{
				...
				itemtype = 16161,
				count = 1,
				description = "<i>You see a crystalline axe (Atk:51, Def:29 +3, axe fighting +1)<p>It can only be wielded properly by players of level 120 or higher.<p>Imbuements (Empty Slot). </p><p>Classification: 2 Tier 0</p><p>It weighs 76.00 oz.</p><p>Even in the light of day, the stars seem to reflect in each facet of this crystalline axe</p></i>",
			...
			},
			{
				...
				itemtype = 16162,
				count = 1,
				description = "<i>You see a mycological mace (Atk:50, Def:31 +3, club fighting +1).<p>It can only be wielded properly by players of level 120 or higher.<p>Imbuements: (Empty Slot).<p>Classification: 2 Tier: 0<p>It weighs 59.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 16175,
				count = 1,
				description = "<i>12:52 You see a shiny blade (Atk:49, Def:35 +2, sword fighting +1).<p><p>It can only be wielded properly by players of level 120 or higher.</p><p>Imbuements: (Empty Slot).</p><p>Classification: 2 Tier: 0</p><p>It weighs 45.00 oz.</p></p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "Glacial_Rod.png" },
				name = "Glacial Rod",
				price = 400,
				itemtype = 16118,
				count = 1,
				description = "<i>You see a glacial rod (magic level +1).<p>It can only be wielded properly by druids of level 65 or higher.</p><p>Classification: 2 Tier: 0</p><p>It weighs 37.00 oz.</p><p>Hurls the icy essence of the Svargrond glaciers</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "Wand_of_Defiance.png" },
				name = "Wand of Defiance",
				price = 400,
				itemtype = 16096,
				count = 1,
				description = "<i>You see a wand of defiance (magic level +1).<p>It can only be wielded properly by sorcerers of level 65 or higher.</p><p>Classification: 2 Tier: 0</p><p>It weighs 37.00 oz.</p><p>It reveals devastating energy arcs</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "Mycological_Bow.png" },
				name = "Mycological Bow",
				price = 400,
				itemtype = 16164,
				count = 1,
				description = "<i>You see a mycological bow (Range: 6, Atk +4, Hit% +4).<p>It can only be wielded properly by paladins of level 105 or higher.</p><p>Imbuements: (Empty Slot, Empty Slot, Empty Slot).</p><p>Classification: 2 Tier: 0</p><p>It weighs 49.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
	...
	offers = {
			{
				icons = { "Mastermind_Shield.png" },
				name = "Mastermind Shield",
				price = 300,
				itemtype = 3414,
				count = 1,
				description = "<i>You see a mastermind shield (Def:37).<p>Imbuements: (Empty Slot).</p><p>It weighs 57.00 oz.</p><p>It's an enchanted shield</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "Spellbook_of_Dark_Mysteries.png" },
				name = "Spellbook of Dark Mysteries",
				price = 300,
				itemtype = 8090,
				count = 1,
				description = "<i>You see a spellbook of dark mysteries (Def:16, magic level +3).<p>It can only be wielded properly by sorcerers and druids of level 80 or higher.</p><p>It weighs 28.50 oz.</p><p>It shows your spells and can also shield against attacks when worn</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "A_Pair_of_Soft_Boots.png" },
				name = "Soft boots",
				price = 300,
				itemtype = 3549,
				count = 1,
				description = "<i>You see a pair of soft boots that is brand-new.<p><p>(Arm:2)</p>HP Regeneration: 150/sec</p><p>Mana Regeneration: 150/sec</p><p>It weighs 8.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 9019,
				count = 1,
				description = "<i>You see a pair of firewalker boots (Arm:2, protection fire field +100%)</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "Jungle_Quiver.png" },
				name = "Jungle Quiver",
				price = 300,
				itemtype = 35524,
				count = 1,
				description = "<i>You see a jungle quiver.<p>It can only be wielded properly by paladins of level 150 or higher.</p><p>It weighs 18.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
