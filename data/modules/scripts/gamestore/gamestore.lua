	...
	-- FENCORE SALE
{
...

	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 47368,
				count = 1,
				description = "<i>You see a amber slayer (Atk:8 physical + 50 death, Def:34, sword fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> Powerful Impact). Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 10 (9.05% Onslaught). It weighs 60.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			...
			},
			{
				...
				itemtype = 47376,
				count = 1,
				description = "<i>You see a amber cudgel (Atk:8 physical + 46 fire, Def:32 +3, club fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> Powerful Impact). Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 10 (9.05% Onslaught). It weighs 68.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			...
			},
			{
				...
				itemtype = 47374,
				count = 1,
				description = "<i>You see a amber sabre (Atk:8 physical + 46 energy, Def:32 +3, sword fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> Powerful Impact). Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 10 (9.05% Onslaught). It weighs 60.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
	...
	offers = {
			...
			},
		{
			...
			itemtype = 943,
			count = 100,
			description = "<i>Using this item on any equipment can increase its Tier up to Tier 10 for all type of item classification. Chance to upgrade is 70%</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			state = GameStore.States.STATE_NEW,
			movable = true,
		},
