...
HomeBanners = {
    images = { "home/sale.png", "home/sale.png" },
    delay = 10,
}
...
GameStore.Categories = {
	-- FENCORE SALE
{
		icons = { "Category_Fencore.png" },
		name = "Fencore SALE",
		rookgaard = true,
		subclasses = { "Weapons", "Equipment", "Extra", "VIP" },
	},
	---- FENCORE SALE Subcategories
		...
		offers = {
			{
				...
				itemtype = 43875,
				count = 1,
				description = "<i>You see a grand sanguine battleaxe (Atk:8 physical + 50 death, Def:35, axe fighting +5, critical hit chance 10%, critical extra damage +12%). It can only be wielded properly by knights of level 600 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 83.00 oz.</i>",
			...
			},
			{
				...
				itemtype = 43873,
				count = 1,
				description = "<i>You see a grand sanguine bludgeon (Atk:8 physical + 50 earth, Def:35, club fighting +5, critical hit chance 10%, critical extra damage +12%). It can only be wielded properly by knights of level 600 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 91.00 oz.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 43867,
				count = 1,
				description = "<i>You see a grand sanguine cudgel (Atk:8 physical + 46 death, Def:32 +3, club fighting +5). It can only be wielded properly by knights of level 600 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 68.00 oz.</p></p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 43869,
				count = 1,
				description = "<i> You see a grand sanguine hatchet (Atk:8 physical + 46 fire, Def:32 +3, axe fighting +5). It can only be wielded properly by knights of level 600 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 72.00 oz. </p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 43871,
				count = 1,
				description = "<i>You see a grand sanguine razor (Atk:8 physical + 50 energy, Def:35, sword fighting +5, critical hit chance 10%, critical extra damage +12%). It can only be wielded properly by knights of level 600 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 79.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 43878,
				count = 1,
				description = "<i>You see a grand sanguine bow (Range: 6, Atk +9, Hit% +6, distance fighting +4, critical hit chance 10%, critical extra damage +12%, protection earth +6%). It can only be wielded properly by paladins of level 600 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 47.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 43880,
				count = 1,
				description = "<i> You see a grand sanguine crossbow (Range: 6, Atk +10, Hit% +7, distance fighting +4, critical hit chance 10%, critical extra damage +12%, protection fire +6%). It can only be wielded properly by paladins of level 600 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 47.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 43886,
				count = 1,
				description = "<i> You see a grand sanguine rod (critical hit chance 20%, critical extra damage +10%, magic level +10, earth magic level +4, ice magic level +4, protection death +35%). It can only be wielded properly by druids of level 600 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 24.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 43883,
				count = 1,
				description = "<i> You see a grand sanguine coil (critical hit chance 15%, critical extra damage +15%, magic level +6, energy magic level +2, fire magic level +2, protection earth +7%). It can only be wielded properly by sorcerers and druids of level 200 or higher. Imbuements: (Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 21.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34084,
				count = 1,
				description = "<i>You see a soulbiter (Atk:7 physical + 45 death, Def:32 +3, axe fighting +5, life leech chance +100%, life leech amount +5%, mana leech chance +100%, mana leech amount +3%). It can only be wielded properly by knights of level 400 or higher. Imbuements: (Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 40.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			...
			},
			{
				...
				itemtype = 34086,
				count = 1,
				description = "<i>You see a soulcrusher (Atk:6 physical + 46 ice, Def:33 +3, club fighting +5, life leech chance +100%, life leech amount +5%, mana leech chance +100%, mana leech amount +3%). It can only be wielded properly by knights of level 400 or higher. Imbuements: (Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 41.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34082,
				count = 1,
				description = "<i>You see a soulcutter (Atk:7 physical + 45 death, Def:32 +3, sword fighting +5, life leech chance +100%, life leech amount +5%, mana leech chance +100%, mana leech amount +3%). It can only be wielded properly by knights of level 400 or higher. Imbuements: (Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 63.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34085,
				count = 1,
				description = "<i> You see a souleater (Atk:10 physical + 47 ice, Def:34, axe fighting +5, critical hit chance 10%, critical extra damage +10%). It can only be wielded properly by knights of level 400 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 72.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34087,
				count = 1,
				description = "<i>You see a soulmaimer (Atk:10 physical + 47 energy, Def:35, club fighting +5, critical hit chance 10%, critical extra damage +10%). It can only be wielded properly by knights of level 400 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 89.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34083,
				count = 1,
				description = "<i>You see a soulshredder (Atk:10 physical + 47 ice, Def:35, sword fighting +5, critical hit chance 10%, critical extra damage +10%). It can only be wielded properly by knights of level 400 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 81.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34088,
				count = 1,
				description = "<i>You see a soulbleeder (Range: 6, Atk +8, Hit% +5, distance fighting +4, critical hit chance 10%, critical extra damage +10%, protection holy +7%). It can only be wielded properly by paladins of level 400 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 47.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34089,
				count = 1,
				description = "<i>You see a soulpiercer (Range: 6, Atk +9, Hit% +6, distance fighting +4, critical hit chance 10%, critical extra damage +10%, protection death +7%). It can only be wielded properly by paladins of level 400 or higher. Imbuements: (Empty Slot, Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 40.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34090,
				count = 1,
				description = "<i>You see a soultainter (critical hit chance 10%, critical extra damage +10%, magic level +5, protection death +12%). It can only be wielded properly by sorcerers of level 400 or higher. Imbuements: (Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 19.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34091,
				count = 1,
				description = "<i>You see a soulhexer (life leech chance +100%, life leech amount +5%, mana leech chance +100%, mana leech amount +3%, magic level +5, protection ice +12%). It can only be wielded properly by druids of level 400 or higher. Imbuements: (Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 25.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
	...
	offers = {
			{
				...
				itemtype = 43884,
				count = 1,
				description = "<i>You see sanguine boots (Arm:3, magic level +2, death magic level +1, protection physical +2%, ice +8%, speed +10). It can only be wielded properly by sorcerers of level 500 or higher. Imbuements: (Empty Slot, Empty Slot). It weighs 19.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 43887,
				count = 1,
				description = "<i>You see a sanguine galoshes (Arm:3, magic level +2, healing magic level +1, protection physical +2%, fire +8%, speed +10). It can only be wielded properly by druids of level 500 or higher. Imbuements: (Empty Slot, Empty Slot). It weighs 17.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 43881,
				count = 1,
				description = "<i>You see a sanguine greaves (Arm:11, distance fighting +4, holy magic level +1, protection physical +7%, energy +9%). It can only be wielded properly by paladins of level 500 or higher. It weighs 32.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 43876,
				count = 1,
				description = "<i>You see a sanguine legs (Arm:12, club fighting +4, sword fighting +4, axe fighting +4, protection physical +9%, death +6%). It can only be wielded properly by knights of level 500 or higher. It weighs 38.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34097,
				count = 1,
				description = "<i>You see pair of soulwalkers (Arm:4, club fighting +1, sword fighting +1, axe fighting +1, protection physical +7%, fire +5%, speed +15). It can only be wielded properly by knights of level 400 or higher. Imbuements: (Empty Slot). It weighs 13.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34099,
				count = 1,
				description = "<i>You see a soulbastion (Def:42, protection physical +10%, death +10%). It can only be wielded properly by knights of level 400 or higher. Imbuements: (Empty Slot). It weighs 58.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34098,
				count = 1,
				description = "<i>You see pair of soulstalkers (Arm:3, distance fighting +1, protection physical +5%, speed +20). It can only be wielded properly by paladins of level 400 or higher. Imbuements: (Empty Slot). It weighs 13.00 oz </p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34094,
				count = 1,
				description = "<i>You see a soulshell (Arm:18, distance fighting +4, protection physical +3%, fire +15%). It can only be wielded properly by paladins of level 400 or higher. Imbuements: (Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 123.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34095,
				count = 1,
				description = "<i>You see a soulmantle (Arm:17, magic level +4, protection physical +4%). It can only be wielded properly by sorcerers of level 400 or higher. Imbuements: (Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 24.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34092,
				count = 1,
				description = "<i>You see a soulshanks (Arm:10, magic level +3, protection death +10%). It can only be wielded properly by sorcerers of level 400 or higher. It weighs 38.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34096,
				count = 1,
				description = "<i>You see a soulshroud (Arm:17, magic level +4, protection death +10%). It can only be wielded properly by druids of level 400 or higher. Imbuements: (Empty Slot, Empty Slot). Classification: 4 Tier: 0 It weighs 24.00 oz</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 34093,
				count = 1,
				description = "<i>You see a soulstrider (Arm:10, magic level +3, protection fire +10%). It can only be wielded properly by druids of level 400 or higher. It weighs 38.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				...
				itemtype = 39150,
				count = 1,
				description = "<i>You see an alicorn quiver (Vol:12). It can only be wielded properly by paladins of level 400 or higher. It weighs 20.00 oz.</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			{
				icons = { "Lit_rainbow_torch.png" },
				name = "Lit Rainbow Torch",
				price = 300,
				itemtype = 39702,
				count = 1,
				description = "<i>You see a Lit Rainbow Torch<p>It creates a magical light around You </p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
			...
			{
				icons = { "Soft_Boots.png" },
				name = "Soft Boots",
				price = 300,
				itemtype = 6529,
				count = 1,
				description = "<i>You see a pair of soft boots that is brand-new. It weighs 8.00 oz. HP & Mana Regeneration 150 / 1 sec</p></i>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
					state = GameStore.States.STATE_NEW,
					movable = true,
			},
	...
	offers = {
			...
			},
		{
			...
			itemtype = 943,
			count = 100,
			description = "<i>Using this item on any equipment can increase its Tier up to Tier 10 for all type of item classification.</i>",
	...
	-- Consumables
	{
		...
		name = "Consumables",
		rookgaard = true,
		subclasses = { "Blessings", "Casks", "Exercise Weapons", "Kegs", "Potions", "Runes" , "Ammunition" },
	},
	...
	},
	{
		...
		offers = {
			{
				icons = { "Crystalline_Arrow.png" },
				name = "Crystalline Arrow",
				price = 50,
				itemtype = 15793,
				count = 250,
				description = "<i>You see 250 crystalline arrows.<p>It can only be wielded properly by players of level 90 or higher.</p><p>It weighs 187.50 oz.</p></i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			movable = true,
			},
			{
				icons = { "Onyx_Arrow.png" },
				name = "Onyx Arrow",
				price = 35,
				itemtype = 7365,
				count = 250,
				description = "<i>You see 250 onyx arrows.<p>It can only be wielded properly by players of level 40 or higher.</p><p>It weighs 175 oz.</p></i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			movable = true,
			},
			{
				icons = { "Prismatic_Bolt.png" },
				name = "Prismatic Bolt",
				price = 50,
				itemtype = 16141,
				count = 250,
				description = "<i>You see 250 prismatic bolts.<p>It can only be wielded properly by players of level 90 or higher.</p><p>It weighs 212.50 oz.</p></i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			movable = true,
			},
			{
				...
				itemtype = 14252,
				count = 250,
				description = "<i>You see 250 prismatic bolts.<p>It can only be wielded properly by players of level 40 or higher.</p><p>It weighs 200 oz.</p></i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			movable = true,
			},
			{
				icons = { "Assasin_Star.png" },
				name = "Assassin Star",
				price = 40,
				itemtype = 7368,
				count = 250,
				description = "<i>You see 250 assassin stars.<p>It can only be wielded properly by players of level 80 or higher.</p><p>It weighs 500 oz.</p></i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			movable = true,
			},
			{
				icons = { "Royal_Spear.png" },
				name = "Royal Spear",
				price = 25,
				itemtype = 7378,
				count = 10,
				description = "<i>You see 10 royal spears.<p>It can only be wielded properly by players of level 25 or higher.</p><p>It weighs 250 oz.</p></i>",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			movable = true,
			},
			},
	...
	-- Cosmetics ~ Outfits (base outfit has addon = 0 or no defined addon. By default addon is set to 0)
	{
		...
		offers = {
			{
				icons = { "Outfit_Afflicted_Male_Addon_3.png", "Outfit_Afflicted_Female_Addon_3.png" },
				name = "Full Afflicted Outfit",
				price = 250,
				sexId = { female = 431, male = 430 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>You feel close to the victims of the fever outbreak. Your clothes make you one of them, one poor soul amongst the countless afflicted.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Assassin_Male_Addon_3.png", "Outfit_Assassin_Female_Addon_3.png" },
				name = "Full Assassin Outfit",
				price = 550,
				sexId = { female = 156, male = 152 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Created by the secret society of Assassins. Only the worthiest can wear their symbols.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Beggar_Male_Addon_3.png", "Outfit_Beggar_Female_Addon_3.png" },
				name = "Full Beggar Outfit",
				price = 150,
				sexId = { female = 157, male = 153 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Made by and for the poorest of Thais citizens.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Brotherhood_Male_Addon_3.png", "Outfit_Brotherhood_Female_Addon_3.png" },
				name = "Full Brotherhood Outfit",
				price = 350,
				sexId = { female = 279, male = 278 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Brotherhood Outfit, created and sold in limited quantities by what is left of one of the ex-strongest guilds in Tibia. Its powerfull dark magic power is worth only the mighties.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Demon_Hunter_Male_Addon_3.png", "Outfit_Demon_Hunter_Female_Addon_3.png" },
				name = "Full Demon Hunter Outfit",
				price = 450,
				sexId = { female = 288, male = 289 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Demon Hunter Outfit, created from the skin of most dangerous demons. Its powerfull equipment is worth only the mighties of the Demon Hunters.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Dragon Slayer Outfit, created from the skin of most dangerous dragons. Its powerfull equipment is worth only the mighties of the Dragon Slayers.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Golden_Male_Addon_3.png", "Outfit_Golden_Female_Addon_3.png" },
				name = "Full Golden Outfit",
				price = 500,
				sexId = { female = 1211, male = 1210 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Made of pure royal gold, the Golden Outfit is the most wanted outfit. His Majesity has requested to create the Golden Outfit within the Kazordoon mines.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Insectoid_Male_Addon_3.png", "Outfit_Insectoid_Female_Addon_3.png" },
				name = "Full Insectoid Outfit",
				price = 230,
				sexId = { female = 466, male = 465 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Insectoid outfit is one of a kind, create by nobody knows who and when. It was first seen worn during hunts in the swam areas. Its wings, shield and dangerous weapon are a rarity to be seen.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Jester_Male_Addon_3.png", "Outfit_Jester_Female_Addon_3.png" },
				name = "Full Jester Outfit",
				price = 220,
				sexId = { female = 270, male = 273 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>A comic outfit specially designed for his Majesty to entertain. The Jester is always prepared to suprise.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Norseman_Male_Addon_3.png", "Outfit_Norseman_Female_Addon_3.png" },
				name = "Full Norseman Outfit",
				price = 320,
				sexId = { female = 252, male = 251 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Armed with a powerful harpoon, and gifted with steady hands as well as a sharp eye, the Norseman Outfit is not one to be trifled with. Requiring both sword skill and strength to properly wield, the harpoon is a mighty tool in the hands of an able norseman, hitting deadly across any enemy.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Pirate_Male_Addon_3.png", "Outfit_Pirate_Female_Addon_3.png" },
				name = "Full Pirate Outfit",
				price = 470,
				sexId = { female = 155, male = 151 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Armed with a powerful sabre, and gifted with steady hands as well as a sharp eye, the Pirate Outfit is not one to be trifled with. Requiring both sword skill and strength to properly wield, the sabre is a mighty tool in the hands of an able pirate, hitting deadly across any enemy.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Simple and clean. Retro Citizen Outfit is a stylish outfit made by a popular craftsman from Thais.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Armed with a powerful equipment, and gifted with steady hands as well as a sharp eye, the Retro Paladin Outfit is not one to be trifled with. Requiring distance skills and strength to properly wield, equipment is a mighty tool in the hands of an able paladin, hitting deadly across any enemy.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Armed with a powerful equipment, and gifted with steady hands as well as a sharp eye, the Retro Knight Outfit is not one to be trifled with. Requiring both hand to hand or weapon skill and strength to properly wield, equipment is a mighty tool in the hands of an able knight, hitting deadly across any enemy.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
			...
			},
			{
				...
				name = "Full Retro Nobleman Outfit",
				price = 350,
				sexId = { female = 966, male = 967 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Gentle and smart. Makes You look like You just left the theatre. Made by the most famous craftsman in Venore. Shares love and harmony</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Armed with a powerful set of potions, and gifted with steady hands as well as a sharp eye, the Retro Summoner Outfit is not one to be trifled with. Requiring both magic skill and strength to properly wield, magical potions are a mighty tool in the hands of an able summoner, hitting deadly spells across any enemy.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Armed with a powerful sword, and gifted with steady hands as well as a sharp eye, the Retro Warrior Outfit is not one to be trifled with. Requiring both sword skill and strength to properly wield, the sword is a mighty tool in the hands of an able warrior, hitting deadly across any enemy.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Shaman_Male_Addon_3.png", "Outfit_Shaman_Female_Addon_3.png" },
				name = "Full Shaman Outfit",
				price = 350,
				sexId = { female = 158, male = 154 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Armed with a powerful set of vodoo items, and gifted with steady hands as well as a sharp eye, the Shaman Outfit is not one to be trifled with. Requiring both dark magic skill and strength to properly wield, the magical items are a mighty tool in the hands of an able shaman, hitting deadly dark spells across any enemy.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Wayfarer_Male_Addon_3.png", "Outfit_Wayfarer_Female_Addon_3.png" },
				name = "Full Warfarer Outfit",
				price = 450,
				sexId = { female = 366, male = 367 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Armed with a powerful zaoan sword, and gifted with steady hands as well as a sharp eye, the Wayferer Outfit is not one to be trifled with. Requiring both sword skill and strength to properly wield, the zaoan sword is a mighty tool in the hands of an able wayferer, hitting deadly across any enemy.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Warmaster_Male_Addon_3.png", "Outfit_Warmaster_Female_Addon_3.png" },
				name = "Full Warmaster Outfit",
				price = 450,
				sexId = { female = 336, male = 335 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Armed with a powerful zaoan spear, and gifted with steady hands as well as a sharp eye, the Warmaster Outfit is not one to be trifled with. Requiring both sword skill and strength to properly wield, the zaoan spear is a mighty tool in the hands of an able warmaster, hitting deadly across any enemy.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Nightmare_Male_Addon_3.png", "Outfit_Nightmare_Female_Addon_3.png" },
				name = "Full Nightmare Outfit",
				price = 400,
				sexId = { female = 269, male = 268 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Armed with a powerful spear, and gifted with steady hands as well as a sharp eye, the Nightmare Outfit is not one to be trifled with. Requiring both skill and strength to properly wield, the spear is a mighty tool in the hands of an able marksman, shooting deadly across great distance.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
	...
	-- Boost
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 14758,
				count = 1,
				description = "<i>Purchase a boost scroll that increases the experience points your character gains from hunting by 50%!</i>\n\n{character}\n{info} lasts for 1 hour hunting time\n{info} paused if stamina falls under 14 hours\n{info} can be purchased up to 9 times between 2 server saves\n{info} price increases with every purchase\n{info} cannot be purchased if an XP boost is already active",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				state = GameStore.States.STATE_NEW,
				movable = true,
			},
