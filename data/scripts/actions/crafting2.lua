                ...
                items = {
                    [1] = {item = "sorcerer's box", -- item name (THIS MUST BE EXACT OR IT WILL NOT WORK!)
                            ...
                            reqItems = { -- items and the amounts in order to craft.
                                    [1] = {item = 49282, count = 50}, -- Seraphim Hammer
                                    [2] = {item = 49283, count = 50}, -- Seraphim Axe
                                    [3] = {item = 49284, count = 50}, -- Seraphim Sword
                                    [4] = {item = 49285, count = 50}, -- Seraphim Rod
                                    [5] = {item = 49286, count = 50}, -- Seraphim Wand
                                    [6] = {item = 49287, count = 50}, -- Seraphim Bow
                                    [7] = {item = 49288, count = 50}, -- Seraphim Crossbow
