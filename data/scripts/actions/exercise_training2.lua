...
local exerciseWeaponsTable = {
	-- MELE
    [46331] = { skill = SKILL_SWORD },
        [46326] = { skill = SKILL_AXE },
        [46328] = { skill = SKILL_CLUB },
        [46330] = { skill = SKILL_SHIELD },

        -- ROD
        [46329] = { skill = SKILL_MAGLEVEL, effect = CONST_ANI_SMALLICE, allowFarUse = true },
        -- RANGE
        [46327] = { skill = SKILL_DISTANCE, effect = CONST_ANI_SIMPLEARROW, allowFarUse = true },
        -- WAND
        [46332] = { skill = SKILL_MAGLEVEL, effect = CONST_ANI_FIRE, allowFarUse = true },
...
local function exerciseTrainingEvent(playerId, tilePosition, weaponId, dummyId)
	...
	_G.OnExerciseTraining[playerId].event = addEvent(exerciseTrainingEvent, vocation:getBaseAttackSpeed() / 3, playerId, tilePosition, weaponId, dummyId)
	return true
end
