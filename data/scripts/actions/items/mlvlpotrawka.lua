...
magicLevelCondition:setParameter(CONDITION_PARAM_STAT_MAGICPOINTS, 15)
magicLevelCondition:setParameter(CONDITION_PARAM_FORCEUPDATE, true)

local birthday = Action()

function birthday.onUse(player, item, fromPosition, target, toPosition, isHotkey)
