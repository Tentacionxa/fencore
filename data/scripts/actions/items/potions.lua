...
[7443] = { vocations = { VOCATION.BASE_ID.PALADIN }, condition = bullseye, effect = CONST_ME_MAGIC_GREEN, description = "Only paladins may drink this potion.", text = "You feel more accurate.", achievement = "Sharpshooter" },
	...
	[46394] = { mana = { 2500, 2700 }, vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID }, level = 4000, flask = 284, description = "Only druids and sorcerers of level 4000 or above may drink this fluid." },
	[46395] = { health = { 2300, 2900 }, mana = { 1600, 2200 }, vocations = { VOCATION.BASE_ID.PALADIN }, level = 4000, flask = 284, description = "Only paladins of level 4000 or above may drink this fluid." },
	[46393] = { health = { 2200, 2500 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 4000, flask = 284, description = "Only knights of level 4000 or above may drink this fluid." },
}
