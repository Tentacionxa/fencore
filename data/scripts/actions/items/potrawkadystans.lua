...
distanceCondition:setParameter(CONDITION_PARAM_SKILL_DISTANCE, 19)
distanceCondition:setParameter(CONDITION_PARAM_FORCEUPDATE, true)

local chicken = Action()

function chicken.onUse(player, item, fromPosition, target, toPosition, isHotkey)
