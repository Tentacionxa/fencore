			...
			items = {
				[1] = {item = "Legendary Castle Box", -- item name (THIS MUST BE EXACT OR IT WILL NOT WORK!)
						...
						reqItems = { -- items and the amounts in order to craft.
								...
								[3] = {item = 43854, count = 30}, -- tainted heart
				...
				[1] = {item = "Bronze Castle Box",
						...
						reqItems = {
							[1] = {item = 43887, count = 1}, --sanguine galoshes
								...
								[3] = {item = 34096, count = 30}, -- soulshroud
				...
				[2] = {item = "Druid's Chest",
						...
						reqItems = {
							[1] = {item = 34018, count = 1}, -- figurine of malice
								...
								[3] = {item = 33921, count = 30}, -- Malice's spine
								[4] = {item = 3063, count = 1}, -- gold ring
				...
				items = {
					...
					[2] = {item = "Paladin's Chest",
							...
							[1] = {item = 34088, count = 1}, -- soulbleeder
								...
								[3] = {item = 39149, count = 30}, --alicorn headguard
				...
				items = {
					[1] = {item = "Golden Castle Box",
							...
							[1] = {item = 3278, count = 1}, -- magic longsword
								...
								[3] = {item = 43870, count = 30}, --sanguine razor
								...
								[12] = {item = 44745, count = 150}, -- mega dragon hearts.
								[13] = {item = 5909, count = 50},-- white piece of cloth
										[14] = {item = 3350, count = 1}, -- bow
								[15] = {item = 44624, count = 1}, -- mystical dragon robe
									...
									[17] = {item = 43874, count = 1},-- sanguine battleaxe
										[18] = {item = 7413, count = 1},-- titan axe
												[19] = {item = 43849, count = 20},-- rotten roots.
													[20] = {item = 5479, count = 100},-- cat's paw.
											[21] = {item = 5944, count = 100},-- soul orbs
										[22] = {item = 6499, count = 2000},-- demonic essence
							},
						},
					...
					[2] = {item = "Knight's Chest",
							...
							reqItems = {
								...
								[16] = {item = 16120, count = 50},-- hardened bone
									[17] = {item = 43968, count = 100},-- sanguine battleaxe
