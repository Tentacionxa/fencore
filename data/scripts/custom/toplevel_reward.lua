...
local PERIOD_TO_REWARD = 14 --DAYS, this is used to know when the frags should start counting... if its 7, so the most fragger of last 7 days will be considered...
