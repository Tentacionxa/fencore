...
local positions = { -- position in map
	top1 = Position(31471, 31771, 7),
	top2 = Position(31470, 31771, 7),
	top3 = Position(31472, 31771, 7)
}
...
local function spawnNpcs()
	...
	if npc1 then
		local npcName1 = string.format("%s [%d]", player1.name, player1.level)
			...
			Game.setStorageValue(576543, npcName1)
	end
	...
	if npc2 then
		...
		Game.setStorageValue(576544, npcName2)
	end
	...
	if npc3 then
		local npcName3 = string.format("%s [%d]", player3.name, player3.level)
			...
			Game.setStorageValue(576545, npcName3)
	end
end
